        ...
        <div class="col-12">
            <div class="welcome-card p-4 p-md-5 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-4">
                ...
                <div class="text-md-end">
                    <span class="badge role-badge px-4 py-2 fs-6">
                    ...
                    <p class="text-muted small mt-2 mb-0"><i class="bi bi-person-vcard me-1"></i> ID: <%= user.getDocumentId() %></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <% if(user.getRoleId() == 2) { // Contador %>
            <div class="col-md-6 mx-auto">
                <div class="action-card text-center p-5 h-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p class="text-secondary mb-4">Revisa las ventas, transacciones registradas y genera reportes financieros.</p>
                    <a href="accountant.jsp" class="btn btn-accent px-5 py-2 rounded-pill">Ver Reportes Financieros</a>
                </div>
            </div>
        ...
        <% } else if(user.getRoleId() == 5) { // Cliente %>
            <div class="col-lg-4 col-md-5">
                <div class="action-card p-4 h-100">
                    ...
                    <% if(request.getParameter("msg") != null) { %>
                        <div class="alert alert-success py-2 small rounded-3 bg-opacity-10 border-success text-success">
                    ...
                    <form action="profile" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label small text-secondary fw-semibold">Cedula</label>
                            <div class="input-group">
                        ...
                        <div class="mb-4">
                            <label class="form-label small text-secondary fw-semibold">Nueva Contrasena</label>
                            <div class="input-group">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="action-card p-4 h-100 d-flex flex-column">
                    <div class="d-flex justify-content-between align-items-center border-bottom border-secondary pb-3 mb-4">
                        ...
                        <a href="catalog.jsp" class="btn btn-sm btn-moto-outline rounded-pill px-3">Ir a Tienda</a>
                    </div>
                        ...
                        <table class="table table-hover align-middle table-borderless">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    if(!hasPurchases) {
                                        out.print("<tr><td colspan='4' class='text-center text-muted py-5'><i class='bi bi-inbox fs-1 d-block mb-2'></i>No has realizado compras aun.</td></tr>");
                                    }
            ...
            <div class="col-md-6">
                <div class="action-card p-4 text-center h-100 d-flex flex-column justify-content-center transition-all">
                    ...
                    <a href="search_product.jsp" class="btn btn-moto rounded-pill px-4 mx-auto mt-auto">Abrir Escaner</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="action-card p-4 text-center h-100 d-flex flex-column justify-content-center transition-all">
                    ...
                    <a href="visual_scanner.jsp" class="btn btn-moto-outline rounded-pill px-4 mx-auto mt-auto">Identificar Pieza</a>
                </div>
            </div>
        ...
        <% } else if(user.getRoleId() == 6) { // Mecanico %>
            <div class="col-md-6">
                <div class="action-card p-5 text-center h-100 d-flex flex-column justify-content-center transition-all">
                    ...
                    <p class="text-secondary mb-4">Gestiona las ordenes de trabajo asignadas a ti y actualiza su estado.</p>
                    <a href="maintenance" class="btn btn-accent rounded-pill px-5 py-2 mt-auto mx-auto">Ingresar al Taller</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="action-card p-5 text-center h-100 d-flex flex-column justify-content-center transition-all">
                    ...
                    <p class="text-secondary mb-4">Verifica disponibilidad de inventario escaneando codigos de barras.</p>
                    <a href="search_product.jsp" class="btn btn-moto-outline rounded-pill px-5 py-2 mt-auto mx-auto">Abrir Escaner</a>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-xl-4 col-lg-5">
                        <div class="action-card p-4 h-100 d-flex flex-column text-center position-relative overflow-hidden">
                            ...
                            <p class="text-accent small mb-4 z-1 fw-medium">Mejor Cajero del Mes</p>
                            ...
                            <div class="mt-auto bg-dark bg-opacity-25 p-3 rounded-3 z-1 border border-secondary border-opacity-25">
                                ...
                                <p class="text-muted small mb-0"><i class="bi bi-box-seam me-1"></i><span id="topCashierSales">0</span> articulos vendidos</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    <div class="action-card p-4 text-center h-100 transition-all">
                        ...
                        <p class="text-secondary small mb-4">Administra el stock y catalogo de repuestos.</p>
                        <a href="inventory" class="btn btn-moto-outline rounded-pill w-100 mt-auto">Gestionar</a>
                    </div>
                </div>
                <% } %>
                ...
                <div class="col-md-4">
                    <div class="action-card p-4 text-center h-100 transition-all">
                        ...
                        <p class="text-secondary small mb-4">Caja registradora con soporte de escaner.</p>
                        <a href="cashier" class="btn btn-accent rounded-pill w-100 mt-auto text-dark">Abrir Caja</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="action-card p-4 text-center h-100 transition-all">
                        ...
                        <p class="text-secondary small mb-4">Escanea o busca articulos rapidamente.</p>
                        <a href="search_product.jsp" class="btn btn-moto-outline rounded-pill w-100 mt-auto">Consultar</a>
                    </div>
                </div>
                <% } %>
            </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-3 col-sm-6">
                    <div class="action-card p-4 text-center h-100 transition-all">
                        ...
                        <p class="text-secondary small mb-4" style="font-size: 0.8rem;">Control de ordenes de trabajo.</p>
                        <a href="maintenance" class="btn btn-sm btn-moto w-100 rounded-pill">Ingresar</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="action-card p-4 text-center h-100 transition-all">
                        ...
                        <p class="text-secondary small mb-4" style="font-size: 0.8rem;">Usuarios y carnets QR.</p>
                        <a href="employees" class="btn btn-sm btn-moto-outline w-100 rounded-pill">Gestionar</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="action-card p-4 text-center h-100 transition-all">
                        ...
                        <p class="text-secondary small mb-4" style="font-size: 0.8rem;">Terminal de fichaje de empleados.</p>
                        <a href="time_tracking.jsp" class="btn btn-sm btn-moto-outline w-100 rounded-pill">Terminal</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="action-card p-4 text-center h-100 transition-all">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('dashboardData?action=graphData')
        ...
        .then(data => {
            ...
            // Colores basados en el CSS global
