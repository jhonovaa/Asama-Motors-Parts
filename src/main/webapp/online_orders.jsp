                    ...
                    <div class="order-card p-4 <%= isNew ? "order-new" : "" %>">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between mb-3 border-bottom border-secondary pb-3">
                            ...
                            <div class="text-md-end mt-3 mt-md-0">
                                ...
                                <div class="mt-2 d-flex flex-column gap-2 align-items-md-end">
                                    <a href="invoice.jsp?orderId=<%= o.getId() %>" target="_blank" class="btn btn-sm btn-outline-primary" style="width: fit-content;">
                                        <i class="bi bi-receipt me-1"></i> Factura Web
                                    </a>
                                    <% if ("COMPLETADO".equals(oStatus) || "ENVIADO".equals(oStatus) || "ENTREGADO".equals(oStatus) || "EN_PREPARACION".equals(oStatus)) { %>
                                    <a href="api/receipt?orderId=<%= o.getId() %>" class="btn btn-sm btn-outline-danger" target="_blank" style="width: fit-content;">
