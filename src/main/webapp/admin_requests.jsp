...
<div class="container-fluid px-4 py-5 mb-5" style="margin-top: 100px; max-width: 1400px;">
    <div class="d-flex align-items-center mb-4 border-bottom border-secondary pb-3">
        ...
        <h2 class="fw-bold mb-0 text-accent">Gestión de Garantías y Devoluciones</h2>
    </div>
        ...
        <div class="table-responsive" style="max-height: 65vh; overflow-y: auto;">
            <table class="table table-hover align-middle table-borderless">
                <thead class="sticky-top" style="background: var(--card-bg); z-index: 10;">
                    <tr>
                        <th class="text-uppercase pb-3">ID</th>
                        <th class="text-uppercase pb-3">Fecha</th>
                        <th class="text-uppercase pb-3">Cliente</th>
                        <th class="text-uppercase pb-3">Repuesto</th>
                        <th class="text-uppercase pb-3 text-center">Tipo</th>
                        <th class="text-uppercase pb-3 text-center">Estado</th>
                        <th class="text-uppercase pb-3 text-center">Acciones</th>
                    </tr>
                </thead>
                <tbody id="requestsTableBody">
                    <tr><td colspan="7" class="text-center text-secondary py-5 fw-bold"><div class="spinner-border spinner-border-sm me-2"></div>Cargando solicitudes...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-secondary shadow-lg" style="background-color: var(--card-bg); color: var(--text-color);">
            <div class="modal-header border-secondary border-opacity-25 pb-3">
                <h5 class="modal-title fw-bold text-accent"><i class="bi bi-file-earmark-text me-2"></i>Detalles de Solicitud #<span id="modalReqId"></span></h5>
            ...
            <form action="adminRequests" method="POST">
                <div class="modal-body p-4">
                    ...
                    <div class="bg-dark bg-opacity-25 rounded-4 p-4 mb-4 border border-secondary border-opacity-25 shadow-sm">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <p class="mb-1 text-secondary small fw-bold text-uppercase letter-spacing-1"><i class="bi bi-person me-1"></i> Cliente</p>
                                <p class="fw-bolder fs-5 mb-0" id="modalClient"></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-1 text-secondary small fw-bold text-uppercase letter-spacing-1"><i class="bi bi-box-seam me-1"></i> Repuesto</p>
                                <p class="fw-bolder fs-5 mb-0" id="modalProduct"></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-1 text-secondary small fw-bold text-uppercase letter-spacing-1"><i class="bi bi-exclamation-triangle me-1"></i> Motivo / Daño</p>
                                <p class="fw-bold fs-6 mb-0" id="modalDamage"></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-1 text-secondary small fw-bold text-uppercase letter-spacing-1"><i class="bi bi-tag me-1"></i> Tipo</p>
                    ...
                    <div class="mb-4">
                        <p class="mb-2 text-secondary small fw-bold text-uppercase letter-spacing-1"><i class="bi bi-chat-left-text me-1"></i> Descripción del Cliente</p>
                    ...
                    <div class="mb-4 text-center">
                        <p class="mb-2 text-secondary small fw-bold text-uppercase letter-spacing-1 text-start"><i class="bi bi-image me-1"></i> Evidencia Fotográfica</p>
                        <img id="modalImage" src="" alt="Imagen adjunta" class="img-fluid rounded-3 shadow-sm border border-secondary border-opacity-25" style="max-height: 250px; display: none;">
                        <a id="modalImageLink" href="#" target="_blank" class="btn btn-sm btn-moto-outline mt-3 rounded-pill fw-bold" style="display: none;"><i class="bi bi-box-arrow-up-right me-1"></i>Abrir imagen completa</a>
                    </div>

                    <hr class="border-secondary opacity-25 my-4">

                    <h6 class="fw-bold mb-3 text-accent fs-5"><i class="bi bi-hammer me-2"></i>Resolución del Administrador</h6>
                    <div class="mb-3">
                    ...
                    <div class="mb-2">
                        <label class="form-label">Respuesta Oficial para el Cliente</label>
                ...
                <div class="modal-footer border-secondary border-opacity-25 pt-3">
                    <button type="button" class="btn btn-outline-secondary rounded-pill fw-bold px-4" data-bs-dismiss="modal">Cerrar</button>
                    <button type="submit" class="btn btn-accent rounded-pill fw-bold px-4"><i class="bi bi-save me-1"></i> Guardar Resolución</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('adminRequests?action=list')
            ...
            .then(data => {
                ...
                tbody.innerHTML = '';
                if(data.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="7" class="text-center text-secondary py-5 fw-bold"><i class="bi bi-inbox fs-1 d-block mb-3"></i>No hay solicitudes registradas actualmente.</td></tr>';
                    return;
                }
    ...
    function openModal(req) {
        ...
        document.getElementById('modalDesc').textContent = req.description || 'Sin descripción adicional.';
