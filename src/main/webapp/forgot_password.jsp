...
<script src="resources/theme.js?v=2"></script>
    ...
    <div class="login-card p-4 p-md-5 shadow-lg" style="width: 100%; max-width: 420px; border-radius: 20px;">
        <div class="text-center mb-4">
            <img src="resources/logo-asama.png" alt="Logo" class="brand-logo-img" onerror="this.outerHTML='<div class=\'brand-icon mx-auto mb-3\'><i class=\'bi bi-shield-lock\'></i></div>'">
            <h3 class="brand-title fw-bold letter-spacing-tight mb-1">Asama<span class="text-accent">MotoParts</span></h3>
            <p class="text-secondary small fw-medium mt-2">Ingresa tu correo para recibir las instrucciones de recuperación.</p>
        </div>
        ...
        <form action="password-reset" method="POST">
            ...
            <div class="mb-4 position-relative">
                ...
                <input type="email" name="email" class="form-control ps-5" placeholder="Correo electrónico" required autofocus>
            </div>
        ...
        <div class="text-center mt-4 pt-3 border-top border-secondary border-opacity-25 d-flex flex-column gap-2">
            <a href="login.jsp" class="text-secondary text-decoration-none small hover-accent transition-all"><i class="bi bi-arrow-left me-1"></i>Volver al inicio de sesión</a>
        </div>
    </div>
</body>
</html>
