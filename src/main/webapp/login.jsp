...
<head>
    ...
    <title>Iniciar Sesion - Asama Moto Parts</title>
...
<script src="resources/theme.js"></script>
    ...
    <div class="login-card p-4 p-md-5 shadow-lg" style="width: 100%; max-width: 420px; border-radius: 20px;">
        <div class="text-center mb-4">
            ...
            <img src="resources/logo-asama.png" alt="Logo Asama" class="brand-logo-img" onerror="this.outerHTML='<div class=\'brand-icon mx-auto mb-3\'><i class=\'bi bi-gear-wide-connected\'></i></div>'">
            
            <h3 class="brand-title fw-bold letter-spacing-tight mb-1">Asama<span class="text-accent">MotoParts</span></h3>
            <p class="text-secondary small fw-medium">Inicia sesion en tu cuenta</p>
        </div>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Cuenta creada!',
                        text: 'Te has registrado exitosamente. Ahora puedes iniciar sesion.',
        ...
        <form action="login" method="POST">
            <div class="mb-3 position-relative">
                ...
                <input type="email" name="email" class="form-control ps-5" placeholder="Correo electronico" required autofocus>
            </div>
            <div class="mb-4 position-relative">
                <div class="position-absolute top-50 start-0 translate-middle-y ps-3 text-secondary">
                    <i class="bi bi-lock"></i>
                </div>
                <input type="password" name="password" class="form-control ps-5" placeholder="Contrasena" required>
            </div>
        ...
        <div class="text-center mt-4 pt-3 border-top border-secondary border-opacity-25 d-flex flex-column gap-2">
            <span class="text-secondary small">¿No tienes cuenta? <a href="register.jsp" class="text-accent text-decoration-none fw-bold">Crear cuenta</a></span>
            <a href="index.jsp" class="text-secondary text-decoration-none small hover-accent transition-all"><i class="bi bi-house me-1"></i>Volver al inicio</a>
        </div>
    </div>
